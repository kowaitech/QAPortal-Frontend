...
export default function Register() {
  ...
  const validateMobileNumber = (value) => {
    if (!value) return true; // Required check is handled by required rule
  ...
  const onSubmit = async (v) => {
    try {
      ...
      const mobileWithCode = v.mobileNumber
        ? `+91${v.mobileNumber}`
        : undefined;
      const payload = {
        ...v,
      ...
      if (v.role === "student") {
        ...
        successMessage =
          "Registration successful! Admin approval is required. You will be able to login once an admin approves your account.";
      } else {
        successMessage =
